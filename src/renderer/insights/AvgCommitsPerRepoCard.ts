...
export function renderAvgCommitsPerRepoCard(
  ...
  <text x="16" y="28" font-family="'Segoe UI', 'Helvetica Neue', Arial, sans-serif" font-size="11" fill="${THEME.silver}">Avg commits per active repo</text>
  ...
  <text x="16" y="68" font-family="'Segoe UI', 'Helvetica Neue', Arial, sans-serif" font-size="12" fill="${THEME.silver}">${totalCommits.toLocaleString()} commits across ${activeRepos} repo${activeRepos !== 1 ? 's' : ''}</text>
